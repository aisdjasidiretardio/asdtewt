...
function getDraftSecret() {
	return "32c31a77-8f6b-4db3-b262-611495f258bb";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "200cab43-4166-4dc4-98fa-943090d40332";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "200cab43-4166-4dc4-98fa-943090d40332") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "200cab43-4166-4dc4-98fa-943090d40332",
		rootBoundaryId
	});
}
/**
...
var royal_game_client_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "fc584b1e4a8a", "default");
...
var metadata$2 = {
	...
	description: "ONECOIN Game II: Royal Pot, Royal Rewards, live wallet weight, claims and verifiable onchain proof."
};
function GameTwoPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(royal_game_client_default, {});
}
