...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-BO8UQv0M.js\")",
	"clientReferenceDeps": {
		"fc584b1e4a8a": {
			"js": [
...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./layout-segment-context-xM1Ru6U-.mjs");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"26f909cfad48": async () => {
		const m = await import("./site-client-Byh5afoj.mjs");
		return { get "default"() {
			return m["default"];
		} };
	},
	"556f1e0fb9a2": async () => {
		const m = await import("./global-site-header-B0gLdqYL.mjs");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./error-boundary-I5y1M9am.mjs");
		return {
			get "ErrorBoundary"() {
	...
	"6be96b483227": async () => {
		const m = await import("./portal-client-CgT83yfM.mjs");
	...
	"d04d64c46e2c": async () => {
		const m = await import("./royal-scroll-DPre3pXP.mjs");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ed7d606e58f7": async () => {
		const m = await import("./styled-components-registry-Dw9HsRRg.mjs");
		return { get "default"() {
			return m["default"];
		} };
	},
	"fc584b1e4a8a": async () => {
		const m = await import("./royal-game-client-cX-lw4q8.mjs");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { ReadonlyURLSearchParams as a, __require as c, app_ssr_entry_default as default, handleSsr, useRouter as i, __toESM as l, getLayoutSegmentContext as n, require_react as o, usePathname as r, stripBasePath as s, require_jsx_runtime as t };
