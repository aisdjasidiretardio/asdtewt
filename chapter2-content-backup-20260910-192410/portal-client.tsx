  ...
  return <>
    <PortalFinal>
      <Container>
        ...
        <PortalFinalTitle>May luck be in your favour. Again. Again. Again.</PortalFinalTitle>
        <PortalFinalCopy>10,000 minted. Seven winners. $7,000 sent. The first game is now part of One Coin history.</PortalFinalCopy>
        <PortalFinalButton href={PROJECT.twitter} target="_blank" rel="noreferrer">
          <span>X</span> Follow Chapter II
        </PortalFinalButton>
      </Container>
    </PortalFinal>
...
export function WinnerRoom() {
  ...
  <Container>
    ...
    <Lead>
      Seven fortunes claimed. $7,000 sent.
    </Lead>

    <DrawStatus>
      <DrawMessage>
        <DrawLabel>
          ALL SEVEN WINNERS HAVE BEEN PAID.
        </DrawLabel>
      </DrawMessage>
    </DrawStatus>
    ...
    <Lead style={{ marginTop:"55px" }}>
      Seven winning One Coin holders received $1,000 each.
      The royal purse has been emptied. The first game is complete.
    </Lead>
  </Container>
</WinnerHero>
...
<WinnersSection>
        <Container>
          <SectionHead>
            ...
            <SectionTitle>
              Seven fortunes claimed.
            </SectionTitle>

            <SectionCopy className="winner-section-copy">
              The first One Coin game is complete. Seven winners received $1,000 each, with $7,000 distributed in total. The draw and payment record were published through the official One Coin account.
            </SectionCopy>
          </SectionHead>
