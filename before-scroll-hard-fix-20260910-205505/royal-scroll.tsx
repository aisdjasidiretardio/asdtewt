...
const entries = [
  ...
  },
  {
    n:"V",
    date:"10 SEP 2026",
    title:"The kingdom remained.",
    body:"The first game ended, but One Coin was never meant to end with it.",
    ...
    <Page>
      ...
      <Hero>
        <Container>
          ...
          <Kicker>The Royal Scroll</Kicker>
          ...
          <Rail>
            ...
            {entries.map(entry => (
              <Entry key={entry.n}>
                ...
                <Number>{entry.n}</Number>

                <Card>

                  <Art src={entry.image} alt="" />
      ...
      <Future>
        <Container>
          <FutureInner>
            ...
            <Kicker style={{color:"var(--pale-gold)"}}>
              The next entry
            </Kicker>
            ...
            <p>
              The bottom of the Royal Scroll remains blank.
            </p>
