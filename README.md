...
to the actual UTC mint-out time:

const MINT_OUT_AT = "2026-09-01T18:00:00Z";

The page automatically adds 24 hours and begins the live countdown.

After Dice reveals the winners, replace:
